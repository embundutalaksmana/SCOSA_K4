 ...
 public void bersih(){
     ...
     private void print_data(){
        ...
        model.addColumn("Alamat");
         try{
            int no = 1;
            String sql = "SELECT * FROM identitas8 order by Kelas asc";
    ...
    private void AbsenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AbsenActionPerformed
        try{
            String sql = "INSERT INTO presensi8(TANGGAL,NIS,NAMA,KELAS,KETERANGAN) VALUES ('"+tgl+"' , '"+NIS_f.getText()+"' , '"+Nama_f.getText()+"' , '"+Kelas_f.getText()+"' , '"+Presen.getSelectedItem()+"')";
            java.sql.Connection conn = (Connection)CONFIG.configDB();
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Input_Absen8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Input_Absen8().setVisible(true);
            }
        });
    }
